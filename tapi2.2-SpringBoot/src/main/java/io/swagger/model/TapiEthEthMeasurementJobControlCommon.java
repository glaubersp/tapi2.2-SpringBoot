...
public class TapiEthEthMeasurementJobControlCommon   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(flrAvailabilityDeltaTime, flrAvailabilitySamples, flrAvailabilityThreshold, measurementInterval, messagePeriod, offsetFromTimeOfTheDay, priority, repetitionPeriod, testIdentifier, timeOfTheDayAlignment);
  }
