...
public class TapiOamOamServicePoint extends TapiCommonAdminStatePac  {
  @JsonProperty("name")
  @Valid
  ...
  public TapiOamOamServicePoint name(List<TapiCommonNameAndValue> name) {
    this.name = name;
    return this;
  }

  public TapiOamOamServicePoint addNameItem(TapiCommonNameAndValue nameItem) {
    if (this.name == null) {
  ...
  **/
  ...
  public TapiOamOamServicePoint localId(String localId) {
  ...
  **/
  ...
  public TapiOamOamServicePoint connectivityServiceEndPoint(TapiConnectivityConnectivityServiceEndPointRef connectivityServiceEndPoint) {
  ...
  **/
  ...
  public TapiOamOamServicePoint mip(TapiOamMipRef mip) {
    this.mip = mip;
    return this;
  }
  ...
  **/
  ...
  public TapiOamOamServicePoint serviceInterfacePoint(TapiCommonServiceInterfacePointRef serviceInterfacePoint) {
  ...
  **/
  ...
  public TapiOamOamServicePoint isMip(Boolean isMip) {
    this.isMip = isMip;
    return this;
  }
  ...
  **/
  ...
  public TapiOamOamServicePoint layerProtocolName(TapiCommonLayerProtocolName layerProtocolName) {
  ...
  **/
  ...
  public TapiOamOamServicePoint mep(TapiOamMepRef mep) {
    this.mep = mep;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TapiOamOamServicePoint tapiOamOamServicePoint = (TapiOamOamServicePoint) o;
    return Objects.equals(this.name, tapiOamOamServicePoint.name) &&
        Objects.equals(this.localId, tapiOamOamServicePoint.localId) &&
        Objects.equals(this.connectivityServiceEndPoint, tapiOamOamServicePoint.connectivityServiceEndPoint) &&
        Objects.equals(this.mip, tapiOamOamServicePoint.mip) &&
        Objects.equals(this.serviceInterfacePoint, tapiOamOamServicePoint.serviceInterfacePoint) &&
        Objects.equals(this.isMip, tapiOamOamServicePoint.isMip) &&
        Objects.equals(this.layerProtocolName, tapiOamOamServicePoint.layerProtocolName) &&
        Objects.equals(this.mep, tapiOamOamServicePoint.mep) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, localId, connectivityServiceEndPoint, mip, serviceInterfacePoint, isMip, layerProtocolName, mep, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TapiOamOamServicePoint {\n");
