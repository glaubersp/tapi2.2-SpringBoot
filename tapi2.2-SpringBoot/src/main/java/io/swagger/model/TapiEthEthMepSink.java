...
public class TapiEthEthMepSink   {
  ...
  public TapiEthEthMepSink addPeerMepIdentifierItem(Integer peerMepIdentifierItem) {
    if (this.peerMepIdentifier == null) {
      this.peerMepIdentifier = new ArrayList<Integer>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.peerMepIdentifier, tapiEthEthMepSink.peerMepIdentifier) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(peerMepIdentifier, lmM, isCsfReported, lmDegThr, bandwidthReport, lmDegm, isCsfRdiFdiEnabled, aisPeriod, aisPriority, unexpectedLtrReceived, lmTfMin);
  }
